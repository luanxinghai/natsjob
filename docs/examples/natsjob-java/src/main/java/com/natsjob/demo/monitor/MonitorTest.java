package com.natsjob.demo.monitor;

import cn.hutool.json.JSONUtil;

import com.natsjob.starter.common.NatsJobClientSubject;
import com.natsjob.starter.domain.NatsJobMonitor;
...
public class MonitorTest {
    public static void main(String[] args) {
        ...
        String subject = NatsJobClientSubject.getMonitorSubject();
        ...
        try (Connection nc = Nats.connect(natsURL)) {
            ...
            nc.createDispatcher()
                    .subscribe(subject, workQueue, (msg) -> {
                        ...
                        //解析data自定义监控逻辑
                        NatsJobMonitor jobMonitor = JSONUtil.toBean(data, NatsJobMonitor.class);
