...
public class MaxTest {
        ...
        try (Connection nc = Nats.connect(natsURL)) {
            ...
            nc.createDispatcher()
                    .subscribe(subject, (msg) -> {
                        ...
                        //自定义场景
                        sendFlowMessage(nc, jobMessage, "client-A", "fail-scene-1", "场景1", "process1", "我是天才");
                        sendFlowMessage(nc, jobMessage, "client-B", "fail-scene-2", "场景2", "process2", "我是伪灵根");
                        sendFlowMessage(nc, jobMessage, "client-C", "fail-scene-3", "场景3", "process3", "打工不嘻嘻");
    ...
    private static void sendFlowMessage(Connection nc, JobMessage jobMessage, String clientId, String sceneId, String sceneName, String status, String reason) {
        ...
        subFlowMessage.setTaskId(jobMessage.getTaskId())
                ...
                .setStatus(status)
                .setReason(reason)
                .setMonitorStatus("monitoring:sms")
