...
public class PlusMemoryTest {
    public static void main(String[] args) {
        String natsURL = "nats://127.0.0.1:4222";
        String subject = NatsJobClientSubject.getVoidPreStartSubject("app", "biz", "owner");
        //自定义下个子流程
        String subjectNextA = NatsJobClientSubject.getVoidPreStartSubject("app", "biz", "owner-nextA");
        String subjectNextB = NatsJobClientSubject.getVoidPreStartSubject("app", "biz", "owner-nextB");
