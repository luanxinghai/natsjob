...
`,[b(`>`,[g(`scrollbar-container`,`
 ...
 `),O(`disabled`,[b(`>`,[E(`scrollbar`,`pointer-events: none;`)])]),b(`>`,[E(`scrollbar`,`
 z-index: 1;
 position: absolute;
 cursor: pointer;
 pointer-events: all;
...
`),at=b([g(`card`,`
 ...
 `,[x({background:`var(--n-color-modal)`}),O(`hoverable`,[b(`&:hover`,`box-shadow: var(--n-box-shadow);`)]),O(`content-segmented`,[b(`>`,[g(`card-content`,`
 padding-top: var(--n-padding-bottom);
 `),E(`content-scrollbar`,[b(`>`,[g(`scrollbar-container`,[b(`>`,[g(`card-content`,`
 padding-top: var(--n-padding-bottom);
 `)])])])])])]),O(`content-soft-segmented`,[b(`>`,[g(`card-content`,`
 margin: 0 var(--n-padding-left);
 padding: var(--n-padding-bottom) 0;
 `),E(`content-scrollbar`,[b(`>`,[g(`scrollbar-container`,[b(`>`,[g(`card-content`,`
 margin: 0 var(--n-padding-left);
 padding: var(--n-padding-bottom) 0;
 `)])])])])])]),O(`footer-segmented`,[b(`>`,[E(`footer`,`
 padding-top: var(--n-padding-bottom);
 `)])]),O(`footer-soft-segmented`,[b(`>`,[E(`footer`,`
 padding: var(--n-padding-bottom) 0;
 margin: 0 var(--n-padding-left);
 `)])]),b(`>`,[g(`card-header`,`
 box-sizing: border-box;
 ...
 `),it,g(`card-content`,[b(`&:first-child`,`
 padding-top: var(--n-padding-bottom);
 `)]),E(`content-scrollbar`,`
 display: flex;
 flex-direction: column;
 `,[b(`>`,[g(`scrollbar-container`,[b(`>`,[it])])]),b(`&:first-child >`,[g(`scrollbar-container`,[b(`>`,[g(`card-content`,`
 padding-top: var(--n-padding-bottom);
 `)])])])]),E(`footer`,`
 box-sizing: border-box;
 padding: 0 var(--n-padding-left) var(--n-padding-bottom) var(--n-padding-left);
 ...
 `,[b(`&:target`,`border-color: var(--n-color-target);`)]),O(`action-segmented`,[b(`>`,[E(`action`,[b(`&:not(:first-child)`,`
 border-top: 1px solid var(--n-border-color);
 `)])])]),O(`content-segmented, content-soft-segmented`,[b(`>`,[g(`card-content`,`
 ...
 `,[b(`&:not(:first-child)`,`
 border-top: 1px solid var(--n-border-color);
 `)])])]),O(`footer-segmented, footer-soft-segmented`,[b(`>`,[E(`footer`,`
 transition: border-color 0.3s var(--n-bezier);
 `,[b(`&:not(:first-child)`,`
 border-top: 1px solid var(--n-border-color);
 `)])])]),O(`embedded`,`
 ...
 `)]))]),ot={title:[String,Function],contentClass:String,contentStyle:[Object,String],contentScrollable:Boolean,headerClass:String,headerStyle:[Object,String],headerExtraClass:String,headerExtraStyle:[Object,String],footerClass:String,footerStyle:[Object,String],embedded:Boolean,segmented:{type:[Boolean,Object],default:!1},size:String,bordered:{type:Boolean,default:!0},closable:Boolean,hoverable:Boolean,role:String,onClose:[Function,Array],tag:{type:String,default:`div`},cover:Function,content:[String,Function],footer:Function,action:Function,headerExtra:Function,closeFocusable:Boolean},st=s({name:`Card`,props:Object.assign(Object.assign({},C.props),ot),slots:Object,setup(e){let t=()=>{let{onClose:t}=e;t&&M(t)},{inlineThemeDisabled:n,mergedClsPrefixRef:r,mergedRtlRef:i,mergedComponentPropsRef:a}=ee(e),o=C(`Card`,`-card`,at,rt,e,r),s=S(`Card`,i,r),l=c(()=>e.size||a?.value?.Card?.size||`medium`),u=c(()=>{let e=l.value,{self:{color:t,colorModal:n,colorTarget:r,textColor:i,titleTextColor:a,titleFontWeight:s,borderColor:c,actionColor:u,borderRadius:d,lineHeight:f,closeIconColor:p,closeIconColorHover:m,closeIconColorPressed:h,closeColorHover:g,closeColorPressed:_,closeBorderRadius:v,closeIconSize:y,closeSize:b,boxShadow:x,colorPopover:S,colorEmbedded:C,colorEmbeddedModal:w,colorEmbeddedPopover:T,[D(`padding`,e)]:E,[D(`fontSize`,e)]:O,[D(`titleFontSize`,e)]:ee},common:{cubicBezierEaseInOut:k}}=o.value,{top:te,left:j,bottom:M}=A(E);return{"--n-bezier":k,"--n-border-radius":d,"--n-color":t,"--n-color-modal":n,"--n-color-popover":S,"--n-color-embedded":C,"--n-color-embedded-modal":w,"--n-color-embedded-popover":T,"--n-color-target":r,"--n-text-color":i,"--n-line-height":f,"--n-action-color":u,"--n-title-text-color":a,"--n-title-font-weight":s,"--n-close-icon-color":p,"--n-close-icon-color-hover":m,"--n-close-icon-color-pressed":h,"--n-close-color-hover":g,"--n-close-color-pressed":_,"--n-border-color":c,"--n-box-shadow":x,"--n-padding-top":te,"--n-padding-bottom":M,"--n-padding-left":j,"--n-font-size":O,"--n-title-font-size":ee,"--n-close-size":b,"--n-close-icon-size":y,"--n-close-border-radius":v}}),d=n?w(`card`,c(()=>l.value[0]),u,e):void 0;return{rtlEnabled:s,mergedClsPrefix:r,mergedTheme:o,handleCloseClick:t,cssVars:n?void 0:u,themeClass:d?.themeClass,onRender:d?.onRender}},render(){let{segmented:e,bordered:t,hoverable:n,mergedClsPrefix:r,rtlEnabled:i,onRender:a,embedded:o,tag:s,$slots:c}=this;return a?.(),f(s,{class:[`${r}-card`,this.themeClass,o&&`${r}-card--embedded`,{[`${r}-card--rtl`]:i,[`${r}-card--content-scrollable`]:this.contentScrollable,[`${r}-card--content${typeof e!=`boolean`&&e.content===`soft`?`-soft`:``}-segmented`]:e===!0||e!==!1&&e.content,[`${r}-card--footer${typeof e!=`boolean`&&e.footer===`soft`?`-soft`:``}-segmented`]:e===!0||e!==!1&&e.footer,[`${r}-card--action-segmented`]:e===!0||e!==!1&&e.action,[`${r}-card--bordered`]:t,[`${r}-card--hoverable`]:n}],style:this.cssVars,role:this.role},y(c.cover,e=>{let t=this.cover?v([this.cover()]):e;return t&&f(`div`,{class:`${r}-card-cover`,role:`none`},t)}),y(c.header,e=>{let{title:t}=this,n=t?v(typeof t==`function`?[t()]:[t]):e;return n||this.closable?f(`div`,{class:[`${r}-card-header`,this.headerClass],style:this.headerStyle,role:`heading`},f(`div`,{class:`${r}-card-header__main`,role:`heading`},n),y(c[`header-extra`],e=>{let t=this.headerExtra?v([this.headerExtra()]):e;return t&&f(`div`,{class:[`${r}-card-header__extra`,this.headerExtraClass],style:this.headerExtraStyle},t)}),this.closable&&f(j,{clsPrefix:r,class:`${r}-card-header__close`,onClick:this.handleCloseClick,focusable:this.closeFocusable,absolute:!0})):null}),y(c.default,e=>{let{content:t}=this,n=t?v(typeof t==`function`?[t()]:[t]):e;return n?this.contentScrollable?f(et,{class:`${r}-card__content-scrollbar`,contentClass:[`${r}-card-content`,this.contentClass],contentStyle:this.contentStyle},n):f(`div`,{class:[`${r}-card-content`,this.contentClass],style:this.contentStyle,role:`none`},n):null}),y(c.footer,e=>{let t=this.footer?v([this.footer()]):e;return t&&f(`div`,{class:[`${r}-card__footer`,this.footerClass],style:this.footerStyle,role:`none`},t)}),y(c.action,e=>{let t=this.action?v([this.action()]):e;return t&&f(`div`,{class:`${r}-card__action`,role:`none`},t)}))}});export{st as t};