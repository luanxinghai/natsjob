...
`),st=g([E(`card`,`
 ...
 `),ot,E(`card-content`,[g(`&:first-child`,`
 padding-top: var(--n-padding-bottom);
 `)]),O(`content-scrollbar`,`
 display: flex;
 flex-direction: column;
 `,[g(`>`,[E(`scrollbar-container`,[g(`>`,[ot])])]),g(`&:first-child >`,[E(`scrollbar-container`,[g(`>`,[E(`card-content`,`
 padding-top: var(--n-padding-bottom);
 `)])])])]),O(`footer`,`
 box-sizing: border-box;
 padding: 0 var(--n-padding-left) var(--n-padding-bottom) var(--n-padding-left);
 ...
 `)]))]),ct={title:[String,Function],contentClass:String,contentStyle:[Object,String],contentScrollable:Boolean,headerClass:String,headerStyle:[Object,String],headerExtraClass:String,headerExtraStyle:[Object,String],footerClass:String,footerStyle:[Object,String],embedded:Boolean,segmented:{type:[Boolean,Object],default:!1},size:String,bordered:{type:Boolean,default:!0},closable:Boolean,hoverable:Boolean,role:String,onClose:[Function,Array],tag:{type:String,default:`div`},cover:Function,content:[String,Function],footer:Function,action:Function,headerExtra:Function,closeFocusable:Boolean};qe(ct);var lt=Object.assign(Object.assign({},C.props),ct),ut=o({name:`Card`,props:lt,slots:Object,setup(e){let t=()=>{let{onClose:t}=e;t&&M(t)},{inlineThemeDisabled:n,mergedClsPrefixRef:r,mergedRtlRef:i,mergedComponentPropsRef:a}=ee(e),o=C(`Card`,`-card`,st,at,e,r),c=S(`Card`,i,r),l=s(()=>e.size||a?.value?.Card?.size||`medium`),u=s(()=>{let e=l.value,{self:{color:t,colorModal:n,colorTarget:r,textColor:i,titleTextColor:a,titleFontWeight:s,borderColor:c,actionColor:u,borderRadius:d,lineHeight:f,closeIconColor:p,closeIconColorHover:m,closeIconColorPressed:g,closeColorHover:_,closeColorPressed:v,closeBorderRadius:y,closeIconSize:b,closeSize:x,boxShadow:S,colorPopover:C,colorEmbedded:w,colorEmbeddedModal:T,colorEmbeddedPopover:E,[h(`padding`,e)]:D,[h(`fontSize`,e)]:O,[h(`titleFontSize`,e)]:ee},common:{cubicBezierEaseInOut:k}}=o.value,{top:te,left:j,bottom:M}=A(D);return{"--n-bezier":k,"--n-border-radius":d,"--n-color":t,"--n-color-modal":n,"--n-color-popover":C,"--n-color-embedded":w,"--n-color-embedded-modal":T,"--n-color-embedded-popover":E,"--n-color-target":r,"--n-text-color":i,"--n-line-height":f,"--n-action-color":u,"--n-title-text-color":a,"--n-title-font-weight":s,"--n-close-icon-color":p,"--n-close-icon-color-hover":m,"--n-close-icon-color-pressed":g,"--n-close-color-hover":_,"--n-close-color-pressed":v,"--n-border-color":c,"--n-box-shadow":S,"--n-padding-top":te,"--n-padding-bottom":M,"--n-padding-left":j,"--n-font-size":O,"--n-title-font-size":ee,"--n-close-size":x,"--n-close-icon-size":b,"--n-close-border-radius":y}}),d=n?w(`card`,s(()=>l.value[0]),u,e):void 0;return{rtlEnabled:c,mergedClsPrefix:r,mergedTheme:o,handleCloseClick:t,cssVars:n?void 0:u,themeClass:d?.themeClass,onRender:d?.onRender}},render(){let{segmented:e,bordered:t,hoverable:n,mergedClsPrefix:r,rtlEnabled:i,onRender:a,embedded:o,tag:s,$slots:c}=this;return a?.(),d(s,{class:[`${r}-card`,this.themeClass,o&&`${r}-card--embedded`,{[`${r}-card--rtl`]:i,[`${r}-card--content-scrollable`]:this.contentScrollable,[`${r}-card--content${typeof e!=`boolean`&&e.content===`soft`?`-soft`:``}-segmented`]:e===!0||e!==!1&&e.content,[`${r}-card--footer${typeof e!=`boolean`&&e.footer===`soft`?`-soft`:``}-segmented`]:e===!0||e!==!1&&e.footer,[`${r}-card--action-segmented`]:e===!0||e!==!1&&e.action,[`${r}-card--bordered`]:t,[`${r}-card--hoverable`]:n}],style:this.cssVars,role:this.role},b(c.cover,e=>{let t=this.cover?y([this.cover()]):e;return t&&d(`div`,{class:`${r}-card-cover`,role:`none`},t)}),b(c.header,e=>{let{title:t}=this,n=t?y(typeof t==`function`?[t()]:[t]):e;return n||this.closable?d(`div`,{class:[`${r}-card-header`,this.headerClass],style:this.headerStyle,role:`heading`},d(`div`,{class:`${r}-card-header__main`,role:`heading`},n),b(c[`header-extra`],e=>{let t=this.headerExtra?y([this.headerExtra()]):e;return t&&d(`div`,{class:[`${r}-card-header__extra`,this.headerExtraClass],style:this.headerExtraStyle},t)}),this.closable&&d(j,{clsPrefix:r,class:`${r}-card-header__close`,onClick:this.handleCloseClick,focusable:this.closeFocusable,absolute:!0})):null}),b(c.default,e=>{let{content:t}=this,n=t?y(typeof t==`function`?[t()]:[t]):e;return n?this.contentScrollable?d(nt,{class:`${r}-card__content-scrollbar`,contentClass:[`${r}-card-content`,this.contentClass],contentStyle:this.contentStyle},n):d(`div`,{class:[`${r}-card-content`,this.contentClass],style:this.contentStyle,role:`none`},n):null}),b(c.footer,e=>{let t=this.footer?y([this.footer()]):e;return t&&d(`div`,{class:[`${r}-card__footer`,this.footerClass],style:this.footerStyle,role:`none`},t)}),b(c.action,e=>{let t=this.action?y([this.action()]):e;return t&&d(`div`,{class:`${r}-card__action`,role:`none`},t)}))}});export{ut as t};